...
echo "Restore All -- Skip MD5 Check:shell:nandroid-restore_openrecovery.sh \"$1\" --all --nocheck" >> "$MENU_FILE"
echo "Restore Selected Skip MD5 Check:shell:nandroid-restore_openrecovery.sh \"$1\" --nocheck" >> "$MENU_FILE""
